...
Apenas algumas sugestões (empíricas) para usufruir o melhor da Internet.
...
- 7. Cuide de seu dinheiro e de seus dados -> "Data is the new Oil".
- 8. Sempre prefira o open source -> Tudo que é aberto/auditável é mais confiável.
- 9. Sempre leia os Termos dos serviços (TOS) -> Evite ser surpreendido (x4).
- 10. Você nunca está totalmente seguro -> Sempre se aprimore. Conhecimento é seu maior patrímonio.
